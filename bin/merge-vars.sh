...
missing=()
for key in features programs theme username homeDirectory gitUsername gitEmail hostname timezone locale hashedPassword monitor terminal browser deepcoolScript location vpn gamemodeGpuDevice stateVersion agsPopupTimeout; do
