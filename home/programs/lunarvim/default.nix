            ...
            require("catppuccin").setup({
              ...
              color_overrides = {
                mocha = {
                  ...
                  mantle = "${colors.colors.mantle}",
                  crust = "${colors.colors.crust}",
                  surface0 = "${colors.colors.surface0}",
                  surface1 = "${colors.colors.surface1}",
                  surface2 = "${colors.colors.surface2}",
                  overlay0 = "${colors.colors.overlay0}",
                  overlay1 = "${colors.colors.overlay1}",
                  overlay2 = "${colors.colors.overlay2}",
                  text = "${colors.colors.text}",
                  subtext0 = "${colors.colors.subtext0}",
                  subtext1 = "${colors.colors.subtext1}",
                  lavender = "${colors.colors.lavender}",
                  blue = "${colors.colors.blue}",
                  sapphire = "${colors.colors.sapphire}",
                  sky = "${colors.colors.sky}",
                  teal = "${colors.colors.teal}",
                  green = "${colors.colors.green}",
                  yellow = "${colors.colors.yellow}",
                  peach = "${colors.colors.peach}",
                  maroon = "${colors.colors.maroon}",
                  red = "${colors.colors.red}",
                  mauve = "${colors.colors.mauve}",
                  pink = "${colors.colors.pink}",
                  flamingo = "${colors.colors.flamingo}",
                  rosewater = "${colors.colors.rosewater}",
                },
              },
